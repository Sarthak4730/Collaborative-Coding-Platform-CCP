...
const Navbar = () => {
    ...
    return <nav className="navbar h-1/12 md:h-[15vh] bg-gradient-to-r from-[#3b82f6] to-[#ef4444] text-white font-bold flex justify-between px-[2vw] items-center">
        <div className="left flex w-1/2 items-center gap-2">
            ...
            <h1 className="w-1/2 text-sm md:text-2xl">Collaborative Coding Platform</h1>
        </div>
        ...
        <div className="right flex justify-end md:justify-end w-1/2 h-full items-center md:gap-4">
            <div className="two-btns md:flex">
                <div className="hover:scale-110 transition flex w-1/4 md:w-[7vw] justify-evenly">
                    ...
                    <h3><a className="hover:text-blue-300 underline md:no-underline" href="https://github.com/Sarthak4730/Collaborative-Coding-Platform-CCP" target="_blank">Github</a></h3>
                </div>
                <div className="hover:scale-110 transition flex w-1/4 md:w-[7vw] justify-evenly">
                    <IoIosMail className="text-2xl"/>
                    <a className="hover:text-blue-300 underline md:no-underline" href="mailto:sarthak.kharade.dev@gmail.com">Contact</a>
                </div>
            </div>
            {
